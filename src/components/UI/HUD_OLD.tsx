            ...
            <div className="flex justify-between items-center pointer-events-auto">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-lg border border-white/10">
                        ...
                        <div className="text-white font-bold">{monthNames[gameDate.month - 1]} {gameDate.year}</div>
                    </div>
                    
                    {/* Seasonal Event Display */}
                    {currentEvent && (
                        <div className="bg-purple-900/50 backdrop-blur-md px-4 py-2 rounded-lg border border-purple-400/30 animate-pulse">
                            <span className="text-xs text-purple-300">🎉 EVENT</span>
                            <div className="text-white font-bold">{currentEvent.name}</div>
                    ...
                    {/* Day/Night Toggle */}
                    <button
                        className="bg-black/40 backdrop-blur-md px-4 py-2 rounded-lg border border-white/10 hover:bg-black/60 transition-all"
                        onClick={() => {
                            soundManager.playUIClick()
                    ...
                    >
                        ...
                        <div className="text-white font-bold">{timeOfDay === 'day' ? '☀️ DAY' : '🌙 NIGHT'}</div>
                    </button>

                    {/* Save/Load Controls */}
                    <div className="flex gap-2">
                        <button
                            className="bg-orange-600/80 hover:bg-orange-600 px-3 py-2 rounded-lg text-white text-xs font-bold transition-all"
                            onClick={() => {
                                soundManager.playUIClick()
                        ...
                        <button
                            className="bg-indigo-600/80 hover:bg-indigo-600 px-3 py-2 rounded-lg text-white text-xs font-bold transition-all"
                            onClick={() => {
                                soundManager.playUIClick()
                                setShowStats(prev => !prev)
                            }}
